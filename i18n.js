  ...
  const LOCALES = {
    pt: {
      ...
      portfolio: {
        ...
        projects: [
          { id:'project-1', title:'Project 1', category_label:'UX', description:'Descrição breve do projeto 1.', full_description:'Descrição completa do projeto 1 com detalhes sobre o processo de design e os resultados obtidos.', tags:['Figma','UX Research','Prototipagem'], link:'#' },
    ...
    en: {
      ...
      portfolio: {
        ...
        projects: [
          { id:'project-1', title:'Project 1', category_label:'UX', description:'Brief description of project 1.', full_description:'Full description of project 1 with details about the design process and results achieved.', tags:['Figma','UX Research','Prototyping'], link:'#' },
